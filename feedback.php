                    ...
                    <div class="mx-auto max-w-xl">
                        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                            <div class="mx-auto w-full max-w-xl text-center">
                                ...
                                <h3 class="text-gray-500 my-2">Want to ask something or share a feedback to "<?=$user != '' ? $user['name'] : '' ?>"?</h3>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <?php if (isset($errors['id'])) : ?>
                                                <p class="dark:text-red-400"> <?= $errors['id'] ?></p>
                                            <?php endif ?>
                                            ...
                                            <?php if (isset($errors['feedback'])) : ?>
                                                <p class="dark:text-red-400"> <?= $errors['feedback'] ?></p>
                                            <?php endif ?>
                                        </div>
                                    </div>
